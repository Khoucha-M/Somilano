...
<div class="top-bar">
    <div class="top-bar-left">
        <ul class="menu">
            ...
            <li class="menu-text">Se connecte</li>
        </ul>
    </div>
...
<div class="row small-up-2 medium-up-3 large-up-6">
    <div class="column">
        ...
        <h3>Pull  </h3>
        <h5>Pull NOELIE Pull tout doux gris</h5>
        <p>35€</p>
        <a href="#" class="button small expanded hollow">GO</a>
    </div>
    <div class="column">
        ...
        <h3>Chemisier  </h3>
        <h5>Chemisier Leo Chemisier imprimé léopard col lavallière couleurs terre, doublé </h5>
        <p>25€</p>
        <a href="#" class="button small expanded hollow">GO</a>
    </div>
    <div class="column">
        ...
        <h3>Pull  </h3>
        <h5>Pull LALY pull couleur moutarde dos nu et detail sur les manches  </h5>
        <p>34€</p>
        <a href="#" class="button small expanded hollow">GO</a>
    </div>
    <div class="column">
...
<div class="callout large secondary">
    <div class="row">
        <div class="large-4 columns">
            <h5><strong>Nous trouvez</strong></h5>
        ...
        <div class="large-3 large-offset-2 columns">
            <ul class="menu vertical">
                <li><p><strong>Notre sociéter</strong></p></li>
                <li><a href="#">
                        Livraison
                        Mentions légales
